...
void ParameterServer::defaultConfig() {
    ...
    config["bagfile_name"]                  = std::string("/home/ross/ros_workspace/bagfiles/bench1-3sweeps3.bag");                  // /home/ross/ros_workspace/bagfiles/testSet/featureStructured3.bag
    ...
    config["min_matches"]                   = static_cast<int> (80);      //25     //if using SiftGPU and GLSL you should use max. 60 matches
