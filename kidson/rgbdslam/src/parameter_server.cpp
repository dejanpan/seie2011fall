...
void ParameterServer::defaultConfig() {
    ...
    config["bagfile_name"]                  = std::string("/home/ross/ros_workspace/bagfiles/bench1-2sweeps.bag");                  ///work/kidson/bag_files/bench1-3sweeps3.bag will be processed if given
    ...
    config["min_matches"]                   = static_cast<int> (40);      //25     //if using SiftGPU and GLSL you should use max. 60 matches
