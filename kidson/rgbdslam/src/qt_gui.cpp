...
void Graphical_UI::setTransformation(QString transf){
...
void Graphical_UI::lastTransformationMatrix() {
...
void Graphical_UI::createMenus() {
    ...
    if(ParameterServer::instance()->get<bool>("use_glwidget"))
    {
      ...
      this->addAction(toggleShowAxisAct);

      QAction *toggleStereoAct = new QAction(tr("Stere&o View"), this);
      toggleStereoAct->setShortcut(QString("O"));
    ...
    QAction *setShiftAct = new QAction(tr("Set Maximum &Depth"), this);
    ...
    actionMenu->addAction(setShiftAct);
