...
public:
	...
	Eigen::Matrix4f getTransformFromMatches(const std::vector<Eigen::Vector4f> & source_feature_locations_3d,
	...
	bool getRelativeTransformationTo(const std::vector<Eigen::Vector4f> & source_feature_locations_3d,
									const std::vector<Eigen::Vector4f> & target_feature_locations_3d,
