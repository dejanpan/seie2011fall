...
public:
		...
		n_(n), it_(n_)
	{
		...
		image_sub_ = it_.subscribe("/camera/image_raw", 1, &ImageSubscriber::imageCallback, this);
		n_.param ("save_image", save_image_, std::string(""));
		winName = "correspondences";
		// here the image of the scene
		n_.param("image_name",imageName,std::string("../data/object7.jpg"));
		cv_image=NULL ;
	...
	void imageCallback(const sensor_msgs::ImageConstPtr& msg_ptr)
	{
		...
		Mat img1 = imread("../data/object4.jpg", 0 );
