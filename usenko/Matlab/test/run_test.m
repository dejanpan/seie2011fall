...
%for  ICRA paper. Scene 3
%prefix ='C:\OSCAR\projects\TUM\object_detection\experiments\Real_scene\parts_scans\parts\scene3b';

%for  RSS paper. 
% prefix ='C:\OSCAR\projects\TUM\object_detection\experiments\Real_scene\ScenesRSStest\cut_office_radig1_';
...
%     plot_points(filtered_features, points, part_centers);
    ...
    for o=1:n_training_objects            
        ...
        %--------------------------------------
        % remove final contributing parts 
        % according to final best hypotheses
        %--------------------------------------
        filter_final_contributing_parts;
        ...
        for p=1:n_r;
            p_id = final_scene_part_contributors(o).parts(p,2);  
